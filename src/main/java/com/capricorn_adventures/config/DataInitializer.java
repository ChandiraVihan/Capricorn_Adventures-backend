    ...
    public CommandLineRunner initializeData(UserRepository userRepository, 
        ...
        return args -> {
            ...
            if (userRepository.count() == 0) {
                ...
                // Create test rooms
                // Assuming Room entity has basic properties
                // If Room structure is different, adjust accordingly
                for (int i = 1; i <= 5; i++) {
                    Room room = new Room();
                    // Set room properties based on actual Room entity structure
                    // This is a basic example - adjust based on your Room entity
